    ...
    return (
      <Container className="about-me-container">
         ...
         <div className="style-content"> 
            ...
            <p> With skills in JavaScript, TypeScript, React, Redux.js, Git, Boostrap, CSS and HTML I aim to create user experiences that are both intuitive and dynamic. </p>
